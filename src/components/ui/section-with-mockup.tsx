...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
    ...
    return (
        <section className="relative py-24 md:py-48 bg-gradient-to-br from-blue-50 to-blue-100 overflow-hidden">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                             className={`absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-blue-200 rounded-[32px] z-0`}
                             style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-white/80 rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-blue-200 z-10 overflow-hidden shadow-2xl"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
